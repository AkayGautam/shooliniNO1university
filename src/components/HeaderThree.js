...
import StickyMenuThree from "./common/StickyMenuThree";
  ...
  return (
   ...
   <span className="iconsFile"> <FaChevronLeft /> </span>
      ...
      <div className="notification-top-bar">
        <Slider {...settings}>
          <div>
          <a class="font-16" target="_blank" href="https://admissions.shooliniuniversity.com/?utm_source=organic&amp;utm_medium=tickerweb&amp;utm_campaign=tickerweb" rel="noreferrer">Seats Filling Up Fast. Apply Now!</a>
          </div>
