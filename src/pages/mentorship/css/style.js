...
.testimonialBlock .img-content {
  clear: both;
  padding: 10px;
  color: rgb(116, 132, 148);
}
.testimonialBlock .team-item {
  display: flex !important;
}
...
.smallCard::before {
  ...
  height: 20px;
  left: 0px;
  background: url(../assets/images/mark-icon.png) 0% 0% / 100%;
}
.smallCard {
  position: relative;
}
...
.card-small h5 {
 ...
 .video-hero--content {
  ...
  background: url(../assets/images/slide9.jpg);
  height: 100%;
...
@media screen and (max-width:767px)
{
  .HerosliderText h1 {
    ...
    max-width: 100%;
    text-shadow: 3px 1px #fff !important;
} 
.HerosliderText p {
  font-size: 14px !important;
  max-width: 250px;
