    ...
    return (
        <>
            ...
            <Suspense>
                ...
                <Head>
                    <title>Engineering Courses, Placements, Admissions 2023 | Shoolini</title>
                    <meta name="description" content="Get admission in Engineering at India's No.2 Engineering University - Shoolini. Check Course details, Placements and Engineering programs available." />
                    <meta name="keywords" content="Engineering courses, No.2 Engineering University in India, Engineering programs, BTech CSE, Bachelors of Technology, BTech, BTech programs, BTech Biotechnology, Yogananda School of AI Computers and Data Science, Shoolini University, School of Mechanical Civil and Electrical Engineering" />
                                                ...
                                                <div>
                                                    ...
                                                    <div className="tab-content mt-md-5">
                                                            ...
                                                            <div className="tabItemData">
                                                                ...
                                                                <div className="row mt-md-5">
                                                                    ...
                                                                    <div className="col-md-6 mt-5">
                                                                        <div className="card-box">
                                                                            <h3 className="title-default"> The brightest minds work with you at a rigorous hub of  <span>  innovation and research. </span></h3> <br />
                                                                            <p> Faculty members are the <strong> brightest minds from the industry and academia</strong>. They have either completed their Doctoral studies at leading universities or have worked in top-tech companies in leadership positions.  <br /> <br />
                                                        ...
                                                        <div className="tab-pane" id="profile">
                                                            ...
                                                            <div className="tabItemData">
                                                                <div className="pagetitle text-center">
                                                                    <h2> Top-Notch Engineering Placements {'&'} Internships </h2>
                                                                </div>
                                                                <div className="dataBrdcrmb text-center">
                                                                    <ul className="p-0 m-0">
                                                                        <li><span> <img src="assets/images/icon1.png" /> </span>
                        ...
                        <section id="specialization" className="student-voices">
                            <div className="container">
                                <div className="row">
                                    <div className="col-md-12">
                                        <div className="card-box">
                                            <h3 className="title-default">Top-Notch Engineering Placements {'&'} Internships</h3>
                        ...
                        <section id="special" className="spiecalisation">
                            <div className="container">
                                <div className="row">
                                    ...
                                    <div className="col-md-6 pr-md-0">
                                        <div className="card-box">
                                            <h3 className="title-default"> Choose More with <span className="text-red"> Shoolini Engineering </span> </h3>
