                                                        ...
                                                        <div className="tab-pane active" id="home">
                                                            <div className="tabItemData">
                                                                ...
                                                                <div className="pagetitle text-center mb-4  ">
                                                                    ...
                                                                    <div className="mt-3">
                                                                        <p>
                                                                            The MBA Program offered by the <strong> School of Business Management</strong> at Shoolini University is designed for the future leaders of the corporate world. In the prestigious NIRF Rankings (2022), the Shoolini Management School figured among the 102-125 best Indian institutions. Shoolini offers an innovative and unique curriculum that delivers transformative educational experiences with cutting-edge specialisations that equip students to excel in an array of job profiles in the corporate world.
                                                                        </p>
                                                                        <div className={isActive ? 'allLogos ' : null} style={{ display: "none" }} >
                                                                            <p>
                                                                                The MBA program at Shoolini aims to achieve <strong> 'Mission 130'</strong>, which means 100% placement and 30% in top companies. The <strong>100% placement record</strong> in recent years speaks volumes about the exceptional education modules. The program combines theoretical knowledge with practical experiences, internships, and campus placements to develop well-rounded professionals. <br />
                                                                                The MBA Program at Shoolini University has been <strong>accredited by the National Board of Accreditation (NBA)</strong>, making it the<strong> first university in Himachal Pradesh</strong> to receive this recognition. Moreover, it is approved by HPPERC (Govt of HP) and UGC.
                                                                ...
                                                                <div className="row mt-md-5">
                                                                    ...
                                                                    <div className="col-md-6">
                                                                        <div id="specialization" className="student-voices">
                                                ...
                                                <div className="moreView">
                                                    ...
                                                    <button className={isActive ? 'btnView ' : "nullRotate"} onClick={toggleClass} >  <Image src="/assets/images/seemore.png" width={70} className="img-responsive rotatebtn" height={65} /></button>
                                                                    ...
                                                                    <div className="col-md-6 mt-5 order-xs-3">
                                                                        <div className="card-box">
                                                                            <h3 className="title-default"> MBA that Gets You Industry-Ready with India's <span> Top Mentorship Program </span></h3> <br />

                                                                            <p> Designed and  <strong> mentored by business leaders from the world’s top 1% companies  </strong>like McKinsey, PwC, Citi and institutions like the IITs, IIMs, ISB, the Shoolini MBA gets you industry ready from the get go. <br /><br />

                                                                                As a full-time MBA student, you will <strong> strong general management and leadership abilities through a rigorous experience-based curriculum. </strong>
                                                                                Our multidisciplinary approach empowers you with the tools to think critically and make sound decisions.<br /><br />
                                                                                Join a collaborative community of faculty, alumni, and peers who will support your success every step of the way. <br /> <br />
                                                                                <strong> Invest in your future</strong>. <strong> <span
                                                                                    className="text-red"> Join our MBA program today!</span></strong>
                                                                            </p>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div className="col-md-6 pl-md-0 mt-5 order-xs-4">
                                                                        <div className="voices-image position-relative">
                                                                            ...
                                                                            <div className="namedes">
                                                                                ...
                                                                                <h5> VC {'&'} Dean, School of Business Management </h5>
                                                                                    ...
                                                                                    <div className="col-md-6 pl-md-0">
                                                                                        <div className="voices-text card-box card-box-dark pt-5">
                                                                                            <h3 className="title-default text-white">MBA graduates <span className="text-red"> land dream
                                                                                                jobs</span> thanks to the mentorship and placement program at Shoolini University</h3>
                                                                                            <p className="text-white text-18"> “The MBA program at Shoolini University exceeded my expectations. The faculty members here are world-class. They provided invaluable training, equipping me with the skills to excel in the business world. Shoolini MBA is both a challenging and transforming experience, professionally as well as personally.” </p>
                                        ...
                                        <div className="card-box">
                                            ...
                                            <div className="courselist">
                                                <ul className="p-0">
                                                    ...
                                                    <li> <a target="_blank" className="nopointer" href="#"> Agri Business </a> </li>
                                                    ...
                                                    <li> <a target="_blank" className="nopointer" href="#"> Communications </a> </li>
                                            ...
                                            <div className="px-0 btn btn-grad-red"> <button onClick={handleShow}  > Need Help? Consult MBA Mentor</button></div>
