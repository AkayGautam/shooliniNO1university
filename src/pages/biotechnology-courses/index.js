...
const Mbas = (props) => {
  ...
  const data = [
    ...
    {
      title:
        "What are the future opportunities after completing biotech or food tech from Shoolini?",
      content:
        "Students can pursue a career in pharmaceuticals, biotechnology, food technology, biomedical science, agri-sciences, environmental management. Students avail international exchange opportunities at campuses like Stanford University (USA) and Gachon University (South Korea).",
    },
...

    {
      ...
      content:
        "We provide competitive internships, training and placement support with various global universities and biotech/food industries. Our students engage in collaborative learning facilitated by group projects and file patents under the guidance of our faculty members. We also follow the one-student one-patent norm.         ",
    },

    {
      title:
        "What are the placement opportunities available for students who have completed Biotech and Food Tech programs at Shoolini University?",
      content:
                    ...
                    <div className="leftCatd">
                      <h1 className="mb-0">
                        ...
                        <span>
                          {" "}
                          Empower Your <br />
                          <strong> Biotech Future </strong>{" "}
                        </span>{" "}
                        <br /> With Next-Gen Programs
                      </h1>
                      <div className="noretype">
                        <p className="border-right-1">
                          {" "}
                          at India's First Biotech University{" "}
                        </p>
                      </div>
                              ...
                              <div className="tabItemData">
                                <div className="pagetitle text-center mb-4  ">
                                  <div className="pagetitle text-center">
                                    <h2>
                                      {" "}
                                      Be at <span> Forefront of</span> Biotech
                                      Innovation{" "}
                                    </h2>
                                  </div>
                                  ...
                                  <div className="mt-3">
                                    <p>
                                      Discover Shoolini University's Faculty of
                                      Applied Sciences {"&"} Biotechnology,{" "}
                                      <strong>
                                        {" "}
                                        India's first Biotech University!
                                      </strong>{" "}
                                      Our{" "}
                                      <strong>
                                        {" "}
                                      ...
                                      offer students unparalleled opportunities
                                      to develop{" "}
                                      <strong>
                                        ground-breaking solutions
                                      </strong>{" "}
                                      that make a real-world impact. From
                                      creating life-saving vaccines to
                                      addressing food shortages and reducing
                                      environmental pollution, our students are
                                      at the forefront of innovation in the
                                      health, food, and environment sectors.
                                    </p>
                                    <div
                                    ...
                                    >
                                      <p>
                                        ...
                                        <strong> technically skilled </strong>{" "}
                                        and{" "}
                                        <strong> capable professionals </strong>{" "}
                                        in biotechnology and related fields. We
                                        provide a range of undergraduate,
                                        masters, and doctoral programs in{" "}
                                        <strong>
                                          {" "}
                                          Biotechnology, Microbiology, Food
                                        ...
                                        . Together, we can tackle complex
                                        challenges in the biotechnology industry
                                ...
                                <div className="dataBrdcrmb text-center">
                                  <ul className="p-0 m-0">
                                    <li>
                                      ...
                                      <strong>
                                        {" "}
                                        1st Biotech University in India
                                      </strong>
                                    </li>
                                    <li>
                                      {" "}
                                      ...
                                      <div className="row my-4">
                                        ...
                                        <div className="col-9">
                                          <div className="sb_text">
                                            ...
                                            <p>
                                              Himachal’s First Commercial Food
                                              Testing Laboratory: Set up with Rs
                                              2.85 crore grant (MOFPI)
                                            </p>
                                          </div>
                                        </div>
                                      </div>
                                  ...
                                  <div className="col-md-6 pr-md-0 order-xs-1">
                                    <div className="card-box">
                                      <h3 className="title-red">
                                        {" "}
                                        Start Your Biotechnology Application
                                      </h3>
                                  ...
                                  <div className="col-md-6 mt-5 order-xs-3">
                                    <div className="card-box">
                                      <h3 className="title-default">
                                        {" "}
                                        Powerhouse Behind Your Success: Meet our
                                        Industry-Savvy Visionary Leaders
                                      </h3>{" "}
                                      <br />
                                      <p>
                                        {" "}
                                        Shoolini University – where nationally
                                        and internationally renowned
                                        academicians and industry leaders guide
                                        students towards achieving their dreams.
                                        Our globally recognised faculty are PhD
                                        and postdoctoral graduates from
                                        prestigious institutions across the
                                        world.
                                        <br />
                                        <br />
                                        At Shoolini, we pride ourselves on our{" "}
                                        <strong>
                                          {" "}
                                        ...
                                        which provide the perfect environment
                                        for learning and conducting
                                        groundbreaking research. We are
                                        especially proud of our{" "}
                                        <strong>
                                          {" "}
                                          Summit Research Program,
                                        </strong>{" "}
                                        the first revolutionary BTech
                                        Biotechnology degree program in India.
                                        <br />
                                        <br />
                                        Our{" "}
                                        <strong>
                                        ...
                                        ensure that Shoolini students receive
                                        the best education and guidance towards
                                        achieving their goals. Let us help you
                                        unlock your full potential and reach new
                                        heights in your academic and
                                  ...
                                  <div className="col-md-6 pl-md-0 mt-5 order-xs-4">
                                    <div className="voices-image position-relative">
                                      ...
                                      <div className="namedes">
                                        ...
                                        <p>
                                          {" "}
                                          PhD Biosciences (Jamia Millia Islamia,
                                          New Delhi), Postdoc Assignments
                                      ...
                                      <div className="row">
                                        <div className="col-md-6">
                                          <div className="card-box">
                                            ...
                                            <p className="text-18">
                                              {" "}
                                              Top-ranked in BioSpectrum and
                                              recognised for excellent Biotech
                                              research by CCI and GTU, the
                                              Faculty of Applied Sciences and
                                              Biotech focuses on bio-molecular
                                              and food engineering, biosensor
                                              tech, etc.
                                            </p>
                                            <p className="mb-1">
                                              <strong>
                                            ...
                                            <ul className="m-0 p-0 list-block">
                                              ...
                                              <li>
                                                Plant Host-Pathogen Interaction
                                              </li>
                                              <li>
                                                Bio-fertilizers and Pest
                                                Biocontrol
                                              </li>
                                              <li>Bioremediation</li>
                                              <li>
                                                Metagenomics of Himalayan
                                                microflora
                                              </li>
                                        ...
                                        <div className="col-md-6">
                                          <div className="card-box">
                                            <div className="row">
                                              <div className="col-md-12">
                                                <h3 className="title-default mb-md-4">
                                                  {" "}
                                                ...
                                                <div className="card-boxs">
                                                  <p className="title-default2 mb-0">
                                                    {" "}
                                                    <Link href="/school-of-biotechnology">
                                                      {" "}
                                                      <strong>
                                                        {" "}
                                                  ...
                                                  <p className="text-18">
                                                    {" "}
                                                    Biotech Studnets are trained
                                                    to become future scientists
                                                    by teaching them molecular
                                                    tools to solve global
                                                    issues. Our program also
                                              ...
                                              <div className="col-md-12">
                                                <div className="card-boxs pt-0 ">
                                                  <p className="title-default2 mb-0">
                                                    <Link href="/school-of-bio-engineering-and-food-technology">
                                                      <strong>
              ...
              <div className="container">
                <div className="row">
                  <div className="col-md-12">
                    <div className="card-box">
                      <h3 className="title-default">
                        250+ Top Biotech <span> Hiring Partners </span>
                      </h3>
                      <p>
                        {" "}
                        <strong>
                        ...
                        <br />
                        Join the Elite Ranks of our Biotech Alumni Network{" "}
                      </p>
                ...
                <div className="row">
                  <div className="col-md-6 pr-md-0">
                    <div className="card-box">
                      <h3 className="title-default">
                        Choose more with{" "}
                        <span className="text-red"> Shoolini Biotech </span>{" "}
                      </h3>
                      <p>
                        {" "}
                        Our future-ready Biotech programs are designed by
                        leading industry experts from the world’s top 1%
                        companies to help you succeed in a dynamic,
                      ...
                      <div className="courselist">
                        <ul className="p-0">
                          <li>
                            {" "}
                            <Link href="/b-tech-bioinformatics">
                              {" "}
                          ...
                          <li>
                            {" "}
                            <Link href="/btech-biotechnology-leet">
                              {" "}
                              BTech Biotechnology (LEET){" "}
                            </Link>{" "}
                          </li>
                          <li>
                            {" "}
                            <Link href="/b-tech-food-technology-leet">
                              {" "}
                              BTech Food Technology LEET{" "}
                            </Link>{" "}
                          </li>

                          <li>
                            {" "}
                            <Link href="/b-tech-food-technology-with-summit-research-program">
                              {" "}
                          ...
                          <li>
                            {" "}
                            <Link href="/bsc-hons-biotechnology">
                              {" "}
                          ...
                          <li>
                            {" "}
                            <Link href="/bsc-hons-microbiology">
                              {" "}
                          ...
                          <li>
                            {" "}
                            <Link href="/bsc-nutrition-and-dietetics">
                              {" "}
                          ...
                          <li>
                            {" "}
                            <Link href="/msc-biotechnology-research">
                              {" "}
                              MSc Biotechnology{" "}
                            </Link>{" "}
                          </li>
                          <li>
                            {" "}
                            <Link href="/msc-food-technology-research">
                              {" "}
                              MSc Food Technology{" "}
                            </Link>{" "}
                          </li>
                          ...
                          <li>
                            {" "}
                            <Link href="/phd-genetic-engineering">
                              {" "}
...
export const getServerSideProps = async () => {
  ...
  const faq = await GetFaq("biotechnology-courses");
