              ...
              <Row>
                <Col md="12">
                  <div className="max-800">
                    ...
                    <div class="sec-title z-index-9"><h2 class="text-dark">Dual Degree Program with University of Melbourne  </h2>
                      <p class="text-dark"> Students can complete two years of their dual degree program in the vibrant city of Melbourne after spending the first two years on the captivating Shoolini campus. This 4-year Bachelor of Science Dual Degree program, called the Global Science and Technology Program, integrates the four core disciplines of Science — Physics, Chemistry, Mathematics, and Bio Sciences — into a common mandatory curriculum for all Year 1 & 2 students. <br /><br />

                        In Year 3 & 4, students can choose subjects from 40+ majors at The University of Melbourne.
                        <br />
              ...
              <Row>
                  ...
                  <div className="card-box">
                    <div className="StoriesData">
                      ...
                      <div className="hgContents">
                        <ul>
                         <li>   Awards a Bachelor of Science Advanced (Honours) degree after 4th year.</li>
                    ...
                    <div className="StoriesData mt-4">
                      ...
                      <div className="hgContents">
                        ...
                        <li> Lectures, tutorials, practical classes, and on-site support were provided for the first 2 years. </li>
                        <li>  Ongoing assessments such as practical reports and essays. </li>
                        <li>  Awards a Bachelor of Science (Honours) degree after 4th year.</li> 
                        </ul>
                      </div>
                    </div>
                ...
                <Col md="6">
                  <div className="card-box p-0">
                    <img className="w-100 img-thumbnail" src="../../assets/images/mb2.jpg" />
                  </div>
                </Col>
              </Row>
            </Container>
                ...
                <Col md="6">
                  <div className="card-box">
                    <div className="StoriesData">
                      ...
                      <div className="hgContents">
                        <ul>
                          <li>After completing their studies, Indian students will be awarded a BSc from The University of Melbourne {'&'} Shoolini University </li> 
                        </ul>
                        <p> Alternative Pathway for students who wish to choose from a diverse range of subjects (42 majors) or to complete further studies in Australia.  
  </p>
                      </div>
                    </div>
                    ...
                    <div className="StoriesData mt-4">
                      ...
                      <div className="hgContents">
                        <ul>
                          <li>   70% and above in Class 12th.  </li>
                          <li>IELTS band score 7.5 in the second year.  </li>
                        </ul>
                      </div>
                    </div>
